...
from .ab_experiments import router as ab_experiments_router, namespace_router as ab_experiments_namespace_router
...
router.include_router(ab_experiments_namespace_router)
