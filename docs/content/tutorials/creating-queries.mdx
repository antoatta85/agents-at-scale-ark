...
description: "Learn how to create and execute queries against agents and teams in ARK"
---
...
Queries support [overrides](/tutorials/overrides) to dynamically inject headers when interacting with models and MCP servers.
...
- Learn about [Creating Tools And MCP Servers](/tutorials/add-custom-tools-with-mcp) to extend agent capabilities
- Check out [Tips on Building Agentic Use Cases](../../how-to-guides/user-guide/tips-on-building-agentic-use-cases) for best practices
