---
title: "Overrides"
description: "Learn how to override headers for models and MCP servers in agents and queries"
---
...
- [Your First Agent](/tutorials/your-first-agent) - Learn about configuring agents
- [Creating Queries](/tutorials/creating-queries) - Learn about creating queries
- [Creating And Managing Models](/tutorials/creating-and-managing-models) - Learn about model configuration
- [Creating Tools And MCP Servers](/tutorials/add-custom-tools-with-mcp) - Learn about MCP servers and tools
