...
description: "Learn how to create, configure, and manage your first AI agent in ARK"
---
...
Agents support [overrides](./overrides) to dynamically inject headers when interacting with models and MCP servers.
...
**Ready for multi-agent coordination?** Learn about [Creating And Managing Teams](./build-a-multi-agent-team).
