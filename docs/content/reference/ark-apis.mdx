...
Start the [dashboard](/how-to-guides/user-guide/dashboard) with `make dashboard` or `ark dashboard`.
...
See the [Authentication Guide](/how-to-guides/development/authentication) for complete configuration details.
