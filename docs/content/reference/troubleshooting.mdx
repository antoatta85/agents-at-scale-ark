...
If Kubernetes or Docker cannot be run in your environment, the best solution would be to run a remote Kubernetes cluster, on AWS/GCP or similar. Check the [Operations Guide](/how-to-guides/operations/deploy-to-kubernetes) on how to do this.
