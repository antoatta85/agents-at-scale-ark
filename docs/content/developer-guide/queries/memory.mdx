...
See the complete test suite demonstrating system message hydration with agent prompt changes:
- **Location**: [`samples/test-system-message-hydration/`](../../../../samples/test-system-message-hydration/)
- **Files**: 
...
- **Documentation**: [`README.md`](../../../../samples/test-system-message-hydration/README.md)
